...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsMoonlight(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsWatermark(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    ...
    IMGUI_API void          ResetButtonAnimations();
    ...
    IMGUI_API bool          CustomCheckbox(const char* label, ImColor color, bool* v);
